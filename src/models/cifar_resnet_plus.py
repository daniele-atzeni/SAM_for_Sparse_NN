...
def ResNet20_2x(**kwargs):
    return ResNet(BasicBlock, [3, 3, 3], width=2, **kwargs)

def ResNet20_4x(**kwargs):
    return ResNet(BasicBlock, [3, 3, 3], width=4, **kwargs)

def ResNet20_8x(**kwargs):
    return ResNet(BasicBlock, [3, 3, 3], width=8, **kwargs)

def ResNet20_16x(**kwargs):
    return ResNet(BasicBlock, [3, 3, 3], width=16, **kwargs)

def ResNet20_32x(**kwargs):
    return ResNet(BasicBlock, [3, 3, 3], width=32, **kwargs)

def ResNet20Homo(**kwargs):
    return ResNet(BasicBlock, [3, 3, 3], homo=True, **kwargs)
