        ...
        for hidden_size in HIDDEN_SIZES:
            for dataset_name in DATASET_NAMES:
                for prune_ratio in PRUNE_RATIOS:
                    ...
                    # save the model
                    model_path = os.path.join(MODEL_SAVE_PATH, f"{MODEL_NAME}_{dataset_name}_hidden_{hidden_size}_sam_{use_sam}_prune_{prune_ratio}.pth")
